...
public class ReportePagado extends javax.swing.JDialog{
	...
	public ReportePagado(JFrame target, MotorBaseDatos BaseDatos2){
		super(target, "Generar reporte por servicios pagados", true);
	...
	private void initComponents(){
        ...
        estatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pagado" }));
	...
	protected void generarReporte(){
        ...
        { 
            ...
            String fileName = "reportes/pagados.jasper";
            ...
            try{
            	...
            	JOptionPane.showMessageDialog(ReportePagado.this, "Error al generar el reporte, modifique sus parámetros.");
            }
            ...
            if(!jasperPrint.getPages().isEmpty()){
            	...
            	JOptionPane.showMessageDialog(ReportePagado.this, "No se generó ningún reporte con estos parámetros, vuelva a intentarlo.");
            }
       }
       catch (Exception j) 
       { 
