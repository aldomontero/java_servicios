...
public class VerRefacciones extends JFrame {
    ...
    private Object[][] data;
    private String[] columnaNombres = {"Codigo", "Refaccion", "Precio"};

    public VerRefacciones(final MotorBaseDatos BaseDatos) {
        super("Listado de Refacciones");
        
        this.BaseDatos = BaseDatos;

        try{
		data = BaseDatos.listaTabla("Refacciones",3);
        }catch(Exception e){
		...
		ImageIcon imgTop = ClaseGlobal.crearIcono("iconos/topRefacciones.jpg");
        ...
        toolNuevo.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				new ControlRefacciones(VerRefacciones.this, BaseDatos, false, null);
			}
		});
        ...
        toolModificar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				new ControlRefacciones(VerRefacciones.this, BaseDatos, false, codigoSeleccionado);
			}
		});
        
        toolInformacion.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				new ControlRefacciones(VerRefacciones.this, BaseDatos, true, codigoSeleccionado);
			}
		});
		...
		toolEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(codigoSeleccionado != null && selectedRow != -1){
					int n = JOptionPane.showConfirmDialog(VerRefacciones.this, "\u00bfEsta seguro que desea eliminar el registro seleccionado?","Confirmar eliminación permanente",JOptionPane.YES_NO_OPTION);		
					if(n == 0)
						if(BaseDatos.eliminar("Refacciones","IdRefaccion="+codigoSeleccionado))
							tableModel.removeRow(selectedRow);
				} else {
					JOptionPane.showMessageDialog(VerRefacciones.this,"Para continuar seleccione un registro de la lista.","Seleccione registro",JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
