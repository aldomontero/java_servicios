...
public class ReporteCliente extends javax.swing.JDialog{
	...
	public ReporteCliente(JFrame target, MotorBaseDatos BaseDatos2){
		super(target, "Generar reporte por Clientes", true);
	...
	private void initComponents(){
        ...
        btnSeleccionarCliente.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				...
				if(bc.getData() != null){
					id.setText(bc.getData()[0]);
					nombreCliente = bc.getData()[1];
				}
			}
        });
        
        estatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos" }));
	...
	protected void generarReporte(){
        ...
        { 
            ...
            String fileName = "reportes/porClientes.jasper";
            ...
            parameters.put("REPORT_NOMBRE_CLIENTE", nombreCliente); 
            parameters.put("REPORT_CODIGO_CLIENTE", id.getText());
            ...
            try{
            	...
            	JOptionPane.showMessageDialog(ReporteCliente.this, "Error al generar el reporte, modifique sus parámetros.");
            }
            ...
            if(!jasperPrint.getPages().isEmpty()){
            	...
            	JOptionPane.showMessageDialog(ReporteCliente.this, "No se generó ningún reporte con estos parámetros, vuelva a intentarlo.");
            }
       }
       catch (Exception j) 
       { 
